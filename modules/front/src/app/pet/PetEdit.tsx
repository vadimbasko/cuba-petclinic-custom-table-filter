...
@injectMainStore
@observer
class PetEditComponent extends React.Component<Props & WrappedComponentProps> {
  ...
  fields = ["identificationNumber", "birthDate", "name"];
  ...
  isNewEntity = () => {
    return this.props.entityId === PetManagement.NEW_SUBPATH;
  };

  render() {
    if (this.updated) {
      return <Redirect to={PetManagement.PATH} />;
    }
...
export default injectIntl(PetEditComponent);
